...
This skill provides **automated code review and intelligent optimization recommendations** based on "Clean Code"
principles. It focuses on **detecting issues, identifying optimization opportunities, and providing actionable
...
To minimize token consumption while ensuring comprehensive analysis, this skill uses a **layered, progressive disclosure
strategy**:
